...
def get_collateralalise_transactions(user_addres, contract):
...
def get_all_user_transactions(user_address):
    ...
    return df
# user_address = '0xe027880CEB8114F2e367211dF977899d00e66138' # borrow and lender
user_address = '0x7B901f40228fC5cA87A288a7C1E88Bc439741fCF' # repayer
...
def make_api_response_string(df):
    ...
    for i in range(temp_df.shape[0]):
        ...
        data.append({
            ...
            "tokenUSDAmount": row['tokenUSDAmount'],
            "lendBorrowType": row['lendBorrowType']
        })
...
# df = get_borrow_transactions(user_address, contract)

# df = get_lend_transactions(user_address, contract)

# df = get_repay_transactions(user_address, contract)

# df = get_collateralalise_transactions(user_address, contract)

df = get_all_user_transactions(user_address)
